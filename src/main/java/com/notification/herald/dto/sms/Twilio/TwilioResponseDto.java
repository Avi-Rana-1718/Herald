...
public record TwilioResponseDto(
    ...
    @JsonProperty("num_media") String numMedia,
    @JsonProperty("num_segments") String numSegments,
    @JsonProperty("price") String price,
    @JsonProperty("price_unit") String priceUnit,
    @JsonProperty("sid") String sid,
    @JsonProperty("status") String status,
    @JsonProperty("subresource_uris") SubresourceUris subresourceUris,
    @JsonProperty("to") String to,
    @JsonProperty("uri") String uri) {
  public record SubresourceUris(@JsonProperty("media") String media) {}
}
