...
class EmailConsumerTest {
  ...
  private final MailRequestDto request =
      new MailRequestDto("Subject", "Body", new UserDto("Alice", "alice@example.com"), "req-abc");
  ...
  void emailConsumer_failure_shouldPersistFailedAndRethrow() throws Exception {
    ...
    assertThatThrownBy(() -> emailConsumer.emailConsumer(request, 1)).isSameAs(cause);
